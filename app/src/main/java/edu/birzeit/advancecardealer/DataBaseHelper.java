...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE CARS(ID INTEGER PRIMARY KEY AUTOINCREMENT, FACTORY_NAME TEXT, TYPE TEXT, PRICE LONG, MODEL TEXT,NAME TEXT,OFFER LONG,YEAR TEXT,FUEL_TYPE TEXT, RATING LONG,ACCIDENT TEXT,IMAGE TEXT,SPARE TEXT,COLOR TEXT,DOORS INTEGER,COMPANY TEXT)");
